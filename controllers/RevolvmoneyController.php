...
use Yii;
use backend\modules\dochub\models\FormAutoBrrvmn;
use backend\modules\dochub\models\FormAutoBrrvmnSearch;
...
use kartik\mpdf\Pdf;
/**
 * FormAutoBrrvmnController implements the CRUD actions for FormAutoBrrvmn model.
 */
class RevolvmoneyController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all FormAutoBrrvmn models.
     * @return mixed
     */
    ...
    /**
     * Displays a single FormAutoBrrvmn model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new FormAutoBrrvmn model.
    ...
    /**
     * Updates an existing FormAutoBrrvmn model.
    ...
    public function actionUpdate($id)
    {
		 ...
		 Yii::$app->view->title = 'ปรับปรุงรายการ '.FormAutoBrrvmn::fn()['name'] . ' หมายเลข: ' . $model->id.' - '. $this->moduletitle;
    ...
    /**
     * Deletes an existing FormAutoBrrvmn model.
    ...
    /**
     * Finds the FormAutoBrrvmn model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return FormAutoBrrvmn the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = FormAutoBrrvmn::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionPdf($id)
    {
        ...
        $intmdl = MainIntercom::find()
            ->where(['staff_id' => $model->user_id])
            ->one();
        $thaibathtext = AdzpireComponent::thaibath($model->amount);
