...
/**
 * FormAutoBrrvmnSearch represents the model behind the search form about `backend\modules\dochub\models\FormAutoBrrvmn`.
 */
class FormAutoBrrvmnSearch extends FormAutoBrrvmn
{
    /**
     * @inheritdoc
     */
