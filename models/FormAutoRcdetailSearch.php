...
/**
 * FormAutoRcdetailSearch represents the model behind the search form about `backend\modules\dochub\models\FormAutoRcdetail`.
 */
class FormAutoRcdetailSearch extends FormAutoRcdetail
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['rcd_id', 'rcd_rcid', 'rcd_amount'], 'integer'],
            [['rcd_detail'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'rcd_id' => $this->rcd_id,
            'rcd_rcid' => $this->rcd_rcid,
            'rcd_amount' => $this->rcd_amount,
        ]);

        $query->andFilterWhere(['like', 'rcd_detail', $this->rcd_detail]);
