...
/**
 * InvtRepairDetailSearch represents the model behind the search form about `backend\modules\dochub\models\InvtRepairDetail`.
 */
class InvtRepairDetailSearch extends InvtRepairDetail
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ird_id', 'ird_irID', 'ird_ivntID', 'ird_tchnchoice'], 'integer'],
            [['ird_symptom', 'ird_tchncomment'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'ird_id' => $this->ird_id,
            'ird_irID' => $this->ird_irID,
            'ird_ivntID' => $this->ird_ivntID,
            'ird_tchnchoice' => $this->ird_tchnchoice,
        ]);

        $query->andFilterWhere(['like', 'ird_symptom', $this->ird_symptom])
            ->andFilterWhere(['like', 'ird_tchncomment', $this->ird_tchncomment]);
