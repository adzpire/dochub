...
use backend\modules\dochub\models\InvtRepair;

/**
 * InvtRepairSearch represents the model behind the search form about `backend\modules\dochub\models\InvtRepair`.
 */
class InvtRepairSearch extends InvtRepair
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ir_id', 'status', 'ir_stID', 'ir_tchnID'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'ir_id' => $this->ir_id,
            'status' => $this->status,
            'ir_stID' => $this->ir_stID,
            'ir_tchnID' => $this->ir_tchnID,
            'ir_date' => $this->ir_date,
            'ir_tchndate' => $this->ir_tchndate,
        ]);
