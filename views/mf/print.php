    ...
    <table  align="center" width="650" border="0" style="background-color:#fff;">
        ...
        <tr>
            <td colspan="2">
                ...
                <p>ข้าพเจ้า .....<u><?php echo $model->mfSt->title->name_th; ?><?php echo $model->mfSt->getFullname('th'); ?></u>
        ...
        <tr>
            <td align="center" width="319" class="tbcontent">
                ...
                <table align="center">
                    <tr>
                        <td>
                            <p>(...<u><?php echo $model->mfSt->title->name_th; ?><?php echo $model->mfSt->getFullname('th'); ?>...)</p>
                        </td>
                    </tr>
                </table>
                <table align="center">
                    <tr>
                        <td>
                            <p>ตำแหน่ง ...<u><?php echo $model->mfSt->position->name_th; ?></u>...</p>
                        </td>
                    </tr>
                </table>
                <table align="center">
        ...
        <tr>
            <td colspan="2" class="tbcontent">
                ...
                <table align="center">
                    <tr>
                        <td>
                            ( ...<u><?php echo $model->mfSt->title->name_th; ?><?php echo $model->mfSt->getFullname('th'); ?></u>... )
                        </td>
                    </tr>
                </table>
                <table align="center">
